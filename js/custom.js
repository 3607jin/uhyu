...
function thmOwlCarousel() {
    if ($('.app-features-carousel').length) {
        $('.app-features-carousel').owlCarousel({
            loop: ($('.app-features-carousel').children().length)==1 ? false:true,
            margin: 30,
            nav: true,
            center: true,
            navText: [
    ...
    if ($('.blog-carousel').length) {
        $('.blog-carousel').owlCarousel({
            loop: ($('.blog-carousel').children().length)==1 ? false:true,
            margin: 30,
            nav: true,
            center: true,
            navText: [
    ...
    if ($('.tweets-carousel').length) {
        $('.tweets-carousel').owlCarousel({
            loop: ($('.tweets-carousel').children().length)==1 ? false:true,
            margin: 0,
            nav: true,
            center: true,
            navText: [
    ...
    if ($('.team-carousel').length) {
        $('.team-carousel').owlCarousel({
            loop: ($('.team-carousel').children().length)==1 ? false:true,
            margin: 30,
            nav: false,
            navText: [
                '<i class="fa fa-angle-left"></i>',
    ...
    if ($('.testimonials-carousel').length) {
        $('.testimonials-carousel').owlCarousel({
            loop: ($('.testimonials-carousel').children().length)==1 ? false:true,
            margin: 0,
            nav: false,
            navText: [
                '<i class="fa fa-angle-left"></i>',
...
function appScreenshotCarousel () {
    if ($('.appScreenshotCarousel-container').length) {
        ...
        var swiper = new Swiper('.appScreenshotCarousel-container', {
            effect: 'coverflow',
            loop: ($('.appScreenshotCarousel-container').children().length)==1 ? false:true,
            centeredSlides: true,
            slidesPerView: 4,
            initialSlide: 4,
